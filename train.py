...
def parse():
    ...
    parser.add_argument('-t', '--data-path-train', type=Path, default='/input/fastmri/2023_snu_fastmri_dataset_onlyimage/train/', help='Directory of train data')
    parser.add_argument('-v', '--data-path-val', type=Path, default='/input/fastmri/2023_snu_fastmri_dataset_onlyimage/val/', help='Directory of validation data')
