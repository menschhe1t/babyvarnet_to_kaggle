...
def parse():
    ...
    parser.add_argument('-s', '--img-size', type=int, default=800, help='Image Resize')
    parser.add_argument('-b', '--batch-size', type=int, default=40, help='Batch size') #size : 1200
    #parser.add_argument('-b', '--batch-size', type=int, default=60, help='Batch size') #size : 800
