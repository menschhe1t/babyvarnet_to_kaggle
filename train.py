...
def parse():
    ...
    parser.add_argument('-t', '--data-path-train', type=Path, default='/kaggle/working/work/train/', help='Directory of train data')
    parser.add_argument('-v', '--data-path-val', type=Path, default='/kaggle/working/work/val/', help='Directory of validation data')
