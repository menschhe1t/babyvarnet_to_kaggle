...
if os.getcwd() + '/kaggle/working/babyvarnet_to_kaggle/utils/model/' not in sys.path:
    sys.path.insert(1, os.getcwd() + '/kaggle/working/babyvarnet_to_kaggle/utils/model/')
from utils.learning.train_part import train
...
def parse():
    ...
    parser.add_argument('-t', '--data-path-train', type=Path, default='/kaggle/input/fastmri/2023_snu_fastmri_dataset_onlyimage/train/', help='Directory of train data')
    parser.add_argument('-v', '--data-path-val', type=Path, default='/kaggle/input/fastmri/2023_snu_fastmri_dataset_onlyimage/val/', help='Directory of validation data')
