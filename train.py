...
def parse():
    ...
    #parser.add_argument('-b', '--batch-size', type=int, default=80, help='Batch size') #size : 800
    #parser.add_argument('-b', '--batch-size', type=int, default=1000, help='Batch size') #size : 100 / debug
    parser.add_argument('-b', '--batch-size', type=int, default=80, help='Batch size') #size : 800
